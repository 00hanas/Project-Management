...
from controllers.member_controller import addMember, getMemberByID, updateMember, getProjectsTasksandDateByMemberID, getAllMembers
...
class AddMemberForm(QDialog):
    ...
    def saveMember(self):
        ...
        loadMember(self.main_window.ui.tableWidget)
...
def expandRow(main_window, row):
    ...
    profile_pic = QLabel()
    profile_pic.setPixmap(QPixmap("icons/accountprof.png").scaled(35, 35)) 
    ...
    stats_label.setStyleSheet("color: black; font-size: 11px;")
    ...
    minimize_button.setIcon(QIcon("icons/minimize.png"))
...
"""
    ...
    task_table.setHorizontalHeaderLabels(["Task", "Project", "Assigned On"])
    print(tasks)
...
""")
    ...
    for i, t in enumerate(tasks):
        task_table.setItem(i, 0, QTableWidgetItem(t["taskName"]))
        task_table.setItem(i, 1, QTableWidgetItem(t["projectName"]))
    ...
    dynamic_height = 60 + total_height
